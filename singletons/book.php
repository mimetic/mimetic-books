...
*/
	 ...
	 * Remote: receive a file from a remote site which has published it.
	 * $remote = use remote package file hosted elsewhere, e.g. on a Content Dist. Network (a TAR file)
	 * 		If remote: $book_id, $u = username, $p = password, $f = file data retrieved from the remote site
	 * 
	 * 
	 * LOCAL
	...
	public function publish_book_package($params = array() ) {
		...
		extract($mb_api->query->get(array('id', 'book_id'), $params));
